...
Public Class WorkSite_Moving
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Repair_System.WorkSite Moving.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedWorkSite_Moving
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As WorkSite_Moving = New WorkSite_Moving()
        rpt.Site = Me.Site
        Return rpt
    End Function
