...
Public Class rpt_Module_Ship
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Repair_System.rpt_Module_Ship.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_Module_Ship
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_Module_Ship = New rpt_Module_Ship()
        rpt.Site = Me.Site
        Return rpt
    End Function
