...
Public Class frm_Material_Warehousing_With_Label
    ...
    Private Sub BTN_ListAdd_Click(sender As Object, e As EventArgs) Handles BTN_ListAdd.Click
        ...
        PrintLabel(TB_CustomerPartCode.Text, TB_PartNo.Text, TB_LotNo.Text, CInt(TB_Qty.Text), TB_Vendor.Text, NumericUpDown1.Value)
    ...
    Private Sub PrintLabel(ByVal custPartCode As String, ByVal partNo As String, ByVal lotNo As String, ByVal qty As Integer, ByVal vendor As String, ByVal printQty As Integer)
    ...
    Private Sub BTN_RePrint_Click(sender As Object, e As EventArgs) Handles BTN_RePrint.Click
        ...
        PrintLabel(Grid_PartList(selRow, 5),
