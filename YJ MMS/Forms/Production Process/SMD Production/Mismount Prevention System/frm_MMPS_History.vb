...
Public Class frm_MMPS_History
    ...
    Private Sub Grid_AllPartsCheck_CellButtonClick(sender As Object, e As RowColEventArgs) Handles Grid_AllPartsCheck.CellButtonClick
        ...
        Select Case e.Col
            Case 10 '알람횟수
                frm_AlarmHistory.checkCode = Grid_AllPartsCheck(e.Row, 1)
                If Not frm_AlarmHistory.Visible Then frm_AlarmHistory.Show()
                frm_AlarmHistory.Focus()
            Case 11 '세부이력
                frm_AllPartsCheckHistory.checkCode = Grid_AllPartsCheck(e.Row, 1)
                If Not frm_AllPartsCheckHistory.Visible Then frm_AllPartsCheckHistory.Show()
                frm_AllPartsCheckHistory.Focus()
        End Select
