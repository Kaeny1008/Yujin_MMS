...
Public Class frm_SMD_Magazine_Kitting
    ...
    Private Sub BTN_Exit_Click(sender As Object, e As EventArgs) Handles BTN_Exit.Click
        ...
        If lastWorkingCount + totalDefectCount + TB_MagazineQty.Text > workingCount Then
            MessageBox.Show(Me,
                            "총 생산수량보다 큽니다.",
                            msg_form,
                            MessageBoxButtons.OK,
    ...
    Private Sub PrintLabel(ByVal writeDate As String)
        ...
        swFile.WriteLine("^FO0008,0162^GB0704,0302,2,B,0^FS")

        swFile.WriteLine("^FO0008,0162^GB0704,0000,2,B,0^FS")
        swFile.WriteLine("^FO0008,0200^GB0704,0000,2,B,0^FS")
        swFile.WriteLine("^FO0008,0238^GB0704,0000,2,B,0^FS")
        swFile.WriteLine("^FO0008,0276^GB0704,0000,2,B,0^FS")
        swFile.WriteLine("^FO0008,0314^GB0704,0000,2,B,0^FS")
        ...
        swFile.WriteLine("^FO0380,0008^A1N,70,50^FD현품표^FS")
        ...
        swFile.WriteLine("^FO0170,0170^A0,30,20^FD" & TB_PONo.Text & "^FS")
