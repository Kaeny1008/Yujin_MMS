...
Public Class Device_Data_RPT_back
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Device_Data_RPT_back.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "YJ_MMS_MMPS.Device_Data_RPT_back.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDevice_Data_RPT_back
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Device_Data_RPT_back = New Device_Data_RPT_back()
        rpt.Site = Me.Site
        Return rpt
    End Function
